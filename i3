...
# Background and text color are used to draw placeholder window conten    ts \
# (when restoring layouts). Border and indicator are ignored.
#client.placeholder #$black #$black #$black #$blue #$white

# Background color which will be used to paint the background of the c    lient \
# window on top of which the client will be rendered. Only clients whi    ch do \
